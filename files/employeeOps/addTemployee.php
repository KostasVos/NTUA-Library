...
<head>
    <meta charset="UTF-8">
    <title>Add Temporary Employee - Databases Project 2019</title>
...
<div class="width_container">
    ...
    <form method="post" action = "addTemployee.php">		
        <div class="width_container">
        ...
        <div class="width_container">
            <label for="contNum">Contract Number:</label> <br>
            <input type="number"  id="contNum" name = "contNum" value="" required>
        </div>
