...
<div class="width_container">
    <section>
        ...
        <a href="./bookOps/addBook.php"><button class=addButton>Add a Book</button></a>
        <a href="./bookOps/searchBook.php"><button class=addButton>Search</button></a>
            ...
            <?php
                ...
                if($query_run = mysqli_query($mysql_connection,$query))
                {
                    while($row = mysqli_fetch_assoc($query_run))
                    {
                        ...
                        echo '<tr><td><a href="./bookOps/bookInfo.php?id='.$ISBN.'" class="no_underline">'.$title.'</a></td><td>'.$ISBN.'</td><td>'.$name.' '.$last.', '.$authYear.'</td><td>'.$pubName.', '.$pubYear.'</td><td>'.$categ.'</td>';
                        echo '<td><a href="./bookOps/editBook.php?id='.$ISBN.'" class="no_underline"><i class="material-icons">border_color</i></a></td>';
                        echo '<td><a href="./bookOps/deleteBook.php?id='.$ISBN.'" class="no_underline"><i class="material-icons" style="color:red">delete</i></a></td></tr>';
